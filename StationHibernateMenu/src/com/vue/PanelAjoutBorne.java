			...
			public void actionPerformed(ActionEvent arg0) {
				...
				{ 
					...
					{ 
						...
						Borne b = new Borne(dateMiseEnService, idStation, type);
						// on l'ajoute à la base de données
						if (AccesData.addBorne(b)) 	{
							// rafraichissement obligatoire depuis la base à cause du numero automatique
