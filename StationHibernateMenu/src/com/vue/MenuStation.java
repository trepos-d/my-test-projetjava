...
public class MenuStation extends JFrame {
	...
	private void affichageStation() {
		this.setContentPane(new PanelStation(unParc));
		this.revalidate();
	}
	private void affichageListeBorneStation() {
		this.setContentPane(new PanelBorneStation(unParc));
		this.revalidate();
	}
	private void affichageAjoutBorne() 	{
		this.setContentPane(new PanelAjoutBorne(unParc));
		this.revalidate();
	}
	private void affichageBorneTypeCharge() {
		this.setContentPane(new PanelBorneTypeCharge(unParc));
		this.revalidate();
	}
}
