...
public class ModeleListeBorneStation extends AbstractTableModel {
	...
	public ModeleListeBorneStation(int idStation) {
		listeBorneStation = AccesData.getListeBorneStation(idStation);
	}
	public List<Borne> getListeBorneStation() {
		return listeBorneStation;
	}
	public void setListeBorneStation(List<Borne> listeBorneStation) {
